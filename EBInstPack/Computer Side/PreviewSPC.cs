namespace EBInstPack
{
    class PreviewSPC
    {
        ...
        public PreviewSPC(Config config, byte[] sampleDirectory, byte[] brrDump, EBMFile song)
        {
            ...
            result = PatchData(result, Padding(0x00, 2), 0x010000);
            result = PatchData(result, Padding(0x00, 2), 0x010010);
            result = PatchData(result, Padding(0x00, 2), 0x010020);
            result = PatchData(result, Padding(0x00, 2), 0x010030);
            result = PatchData(result, Padding(0x00, 2), 0x010040);
            result = PatchData(result, Padding(0x00, 2), 0x010050);
            result = PatchData(result, Padding(0x00, 2), 0x010060);
            result = PatchData(result, Padding(0x00, 2), 0x010070);
